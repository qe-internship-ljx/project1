...
Output:
  output/expanding_window/VVIX MA5/unbound_base_return_shift_VVIX_MA5.png
"""
...
def main():
    ...
    plot_unbound(
        ...
        mu_series=mu_ser,
        out_path=out_dir / "unbound_base_return_shift_VVIX_MA5.png",
        extra_title="\nPositions flat before VVIX activation (2006-03-06)",
    )

    print("\nDone.")
    print("  output/expanding_window/VVIX MA5/unbound_base_return_shift_VVIX_MA5.png")
    print("=" * 72)
