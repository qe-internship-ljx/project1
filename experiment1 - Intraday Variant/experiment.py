"""
experiment1 - Intraday Variant/experiment.py
============================================
VRP Experiment — Intraday-Based Realized Variance

Key differences from "experiment1 - HAR VRP Computation"/experiment.py:
...
def load_intraday_rv() -> pd.DataFrame:
    ...
    Output columns (monthly %²-units, same convention as Bekaert_Hoerova_Replication):
