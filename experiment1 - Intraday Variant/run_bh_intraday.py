...
run_bh_intraday.py
==================
Replicates Bekaert_Hoerova_Replication/run_replication.py exactly, but uses intraday
...
# Import intraday RV loader from experiment.py and HAR model from
# Bekaert_Hoerova_Replication
...
# ─────────────────────────────────────────────────────────────────────────────
# Plotting — identical layout to Bekaert_Hoerova_Replication/run_replication.py
# ─────────────────────────────────────────────────────────────────────────────
...
def plot_bh_formulation_summary(
    ...
    """
    Two-panel figure (identical layout to Bekaert_Hoerova_Replication):
