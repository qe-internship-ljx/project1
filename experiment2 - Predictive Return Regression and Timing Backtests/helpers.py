...
VRP_OUT = ROOT.parent / "experiment1 - HAR VRP Computation" / "output"

BH_DIR = ROOT.parent / "Bekaert_Hoerova_Replication"
sys.path.insert(0, str(BH_DIR))
sys.path.insert(0, str(ROOT.parent))
# FH (2019) cross-sectional model
...
# Sourced from Fassas_Hourvouliades_Replication (Fassas & Hourvouliades, 2019) — see
# Fassas_Hourvouliades_Replication/fh_replication.py for the full implementation.
# ═══════════════════════════════════════════════════════════════════════════
# compute_vix_term_slope is imported from Fassas_Hourvouliades_Replication.fh_replication above.
