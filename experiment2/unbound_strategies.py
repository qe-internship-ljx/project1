...
def plot_unbound_asymmetric_comparison(sim_vvix, sim_biv, sim_term, bah_sim, out_path):
    ...
    def _cum(sim):
        net = sim["net_pnl"][sim.index >= start]
        return (1 + net).cumprod()

    def _stats(sim, label):
    ...
    e_dt = max(sim_vvix.index[-1], sim_biv.index[-1], sim_term.index[-1])
...
def main():
    ...
    plot_unbound_bivariate(
        ...
        out_term / "unbound_symmetric_VRP_+_Term_Slope.png",
    )
    ...
    plot_unbound_bivariate(
        ...
        out_term / "unbound_asymmetric_VRP_+_Term_Slope.png",
    )
    ...
    plot_unbound_bivariate(
        ...
        sim, betas_term, bah_sim, yh_term, mu_20d,
        out_term / "unbound_base_return_shift_VRP_+_Term_Slope.png",
    )
    ...
    plot_unbound_bivariate(
        ...
        out_oi / "unbound_symmetric_VRP_+_Open_Interest.png",
    )
    ...
    plot_unbound_bivariate(
        ...
        sim, betas_oi, bah_sim, yh_oi, mu_20d,
        out_oi / "unbound_asymmetric_VRP_+_Open_Interest.png",
    )
    ...
    plot_unbound_bivariate(
        ...
        sim, betas_oi, bah_sim, yh_oi, mu_20d,
        out_oi / "unbound_base_return_shift_VRP_+_Open_Interest.png",
    )
    ...
    plot_unbound_asymmetric_comparison(
        ...
        out_cmp / "unbound_asymmetric_vvix_vs_vrp_vvix.png",
    )
    ...
    print("  output/expanding_window/VRP + Term Slope/unbound_symmetric_VRP_+_Term_Slope.png")
    print("  output/expanding_window/VRP + Term Slope/unbound_asymmetric_VRP_+_Term_Slope.png")
    print("  output/expanding_window/VRP + Term Slope/unbound_base_return_shift_VRP_+_Term_Slope.png")
    print("  output/expanding_window/VRP + Open Interest/unbound_symmetric_VRP_+_Open_Interest.png")
    print("  output/expanding_window/VRP + Open Interest/unbound_asymmetric_VRP_+_Open_Interest.png")
    print("  output/expanding_window/VRP + Open Interest/unbound_base_return_shift_VRP_+_Open_Interest.png")
    print("  output/expanding_window/comparisons/unbound_asymmetric_vvix_vs_vrp_vvix.png")
    print("=" * 72)
