...
rest is delegated to ``cross_market`` (in "experiment3 - Euro Stoxx 50 Cross-Market").
...
Outputs/caches land in "experiment3 - Nasdaq 100 Cross-Market"/output.
"""
...
sys.path.insert(0, str(ROOT.parent))   # project root, for the FH package import
sys.path.insert(0, str(ROOT.parent / "experiment2 - Predictive Return Regression and Timing Backtests"))
sys.path.insert(0, str(ROOT.parent / "experiment3 - Euro Stoxx 50 Cross-Market"))
...
from Fassas_Hourvouliades_Replication.fh_replication import compute_vix_term_slope
import cross_market
