# sc_replication — Simon & Campasano (2014) VIX Futures Basis Trading
...
```bash
python -m sc_replication.run_analysis     # full replication, ~all exhibits + 8 PNGs
python -m sc_replication.diagnose_short   # short-leg diagnostic tables
```
