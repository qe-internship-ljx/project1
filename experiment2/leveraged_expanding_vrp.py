"""
leveraged_expanding_vrp.py
==========================
Runs the three leveraged position-sizing strategies (symmetric, asymmetric,
base_return_shift) on the Expanding VRP model and saves the plots to:
  ...
  output/expanding_window/poor_correlation/Expanding VRP/
    leveraged_symmetric_VRP.png
    leveraged_asymmetric_VRP.png
    leveraged_base_return_shift_VRP.png

Uses the same cached positions and betas as leveraged_strategies.py (VP predictor).
"""
...
def main():
    ...
    plot_unbound_univariate(
        ...
        out_dir / "leveraged_symmetric_VRP.png",
    )
    ...
    plot_unbound_univariate(
        ...
        sim, betas_vrp, bah_sim, yh_vrp, mu_20d,
        out_dir / "leveraged_asymmetric_VRP.png",
    )
    ...
    plot_unbound_univariate(
        ...
        sim, betas_vrp, bah_sim, yh_vrp, mu_20d,
        out_dir / "leveraged_base_return_shift_VRP.png",
    )

    print("\nDone.")
    print(f"  {out_dir}/leveraged_symmetric_VRP.png")
    print(f"  {out_dir}/leveraged_asymmetric_VRP.png")
    print(f"  {out_dir}/leveraged_base_return_shift_VRP.png")
    print("=" * 72)
