...
base_strategies.py and leveraged_strategies.py (all in "experiment2 - Predictive
Return Regression and Timing Backtests") — on an arbitrary market panel.

This module lives in "experiment3 - Euro Stoxx 50 Cross-Market"; the NASDAQ
experiment imports it from here (see
"experiment3 - Nasdaq 100 Cross-Market"/nasdaq_experiment.py).
...
EXP2 = ROOT.parent / "experiment2 - Predictive Return Regression and Timing Backtests"
